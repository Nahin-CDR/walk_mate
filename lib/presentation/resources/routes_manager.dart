...
import 'package:walkmate/presentation/completed_walk/completed_walk_view.dart';
import 'package:walkmate/presentation/resources/string_manager.dart';
import 'package:walkmate/presentation/set_limit/set_limit_view.dart';
import 'package:walkmate/presentation/splash/splash.dart';
  ...
  static Route<dynamic> getRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case Routes.completeRoute:
        ...
        return MaterialPageRoute(
            builder: (BuildContext context) => CompletedView(
                  totalDistance: distance,
                ));
      case Routes.setLimit:
        return MaterialPageRoute(
            builder: (BuildContext context) => const SetLimitView());
      default:
